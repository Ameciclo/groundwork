...
# Setup PostgreSQL Database Users for Each Application
# This script creates dedicated database users with appropriate permissions
# for Strapi, Atlas, and Zitadel applications.
...
if [ -z "$POSTGRES_ADMIN_PASSWORD" ]; then
    ...
    echo "Usage: POSTGRES_ADMIN_PASSWORD='your-password' ./setup-database-users.sh"
    exit 1
fi
...
echo "Next Steps:"
echo "=========================================="
echo "1. Update Kubernetes secrets with these credentials"
echo "2. Update application configurations to use dedicated users"
